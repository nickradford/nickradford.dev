...
![Part of the npmjs.com ui, letting a maintainer select a publisher to configure trusted publishing with](/npm-trusted-publishing-and-github-actions/select-publisher.png)
...
![The form to configure your trusted publisher](/npm-trusted-publishing-and-github-actions/trusted-publisher-settings.png)
...
[This GitHub issue](https://github.com/actions/setup-node/issues/213) has some explanation, firstly that each install of node comes bundled with npm. For instance, node 22 comes with npm\@10.9.4. Another comment mentions that the node team is considering moving npm into corepack.&#x20;
...
Given that this feature request been open for over 5 years, and has many references from issues and PRs in _other_ projects, I think its safe to say that this is a feature that won't be coming to the action any time soon.
