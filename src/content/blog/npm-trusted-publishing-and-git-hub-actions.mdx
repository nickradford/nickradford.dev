...
After setting up node, presumably using `actions/setup-node@v4`, you must install a version of npm which understands the trusted publishing workflow, which is 11.5.1 or later.
