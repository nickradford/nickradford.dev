...
![Part of the npmjs.com ui, letting a maintainer select a publisher to configure trusted publishing with](/npm-trusted-publishing-and-git-hub-actions/select-publisher.png)
...
![The form to configure your trusted publisher](/npm-trusted-publishing-and-git-hub-actions/trusted-publisher-settings.png)
