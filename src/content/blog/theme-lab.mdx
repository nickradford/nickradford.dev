...
<figure className="not-prose my-10">
  <img
    src="/theme-lab/website-too-yellow.png"
    alt="A warm yellow light mode screenshot of nickradford.dev."
    width={2720}
    height={1708}
...
<figure className="not-prose my-10 grid gap-4 md:grid-cols-2">
  <img
    src="/theme-lab/theme-lab-light-controls.png"
    alt="Theme Lab light mode controls showing presets and editable color values."
    width={818}
    height={1502}
    className="block w-full rounded-lg"
  />
  <img
    src="/theme-lab/theme-lab-dark-controls.png"
    alt="Theme Lab dark mode controls showing presets and editable color values."
    width={820}
    height={1504}
    className="block w-full rounded-lg"
  />
...
<figure className="not-prose my-10 grid gap-4 md:grid-cols-2">
  <img
    src="/theme-lab/theme-lab-mood-light.png"
    alt="Theme Lab light mode Mood editor with a two-axis mood pad and glow slider."
    width={812}
    height={1532}
    className="block w-full rounded-lg"
  />
  <img
    src="/theme-lab/theme-lab-mood-dark.png"
    alt="Theme Lab dark mode Mood editor with a two-axis mood pad and glow slider."
    width={818}
    height={1536}
    className="block w-full rounded-lg"
  />
...
<figure className="not-prose my-10">
  <video
    src="/theme-lab/theme-lab-light-loop.mp4"
    autoPlay
    muted
    loop
    playsInline
    preload="metadata"
    aria-label="Theme Lab light mode demo looping through color palettes"
    className="block w-full rounded-lg"
  />
  <figcaption className="mt-3 font-geist-mono text-sm text-zinc-600 dark:text-zinc-400">
...
<section
  ...
  className="not-prose mt-16 border-t border-accent/20 pt-10 dark:border-zinc-800"
>
  <div className="theme-gallery-slider relative aspect-[2720/1708] overflow-hidden rounded-lg">
    <img
      src="/theme-lab/theme-gallery-light-aqua-orange.png"
      alt="Theme Lab generated light palette with pale aqua surfaces and orange accents."
      width={2720}
      height={1708}
      loading="lazy"
      decoding="async"
      className="theme-gallery-slider__image absolute inset-0 size-full object-cover"
    />
    <img
      src="/theme-lab/theme-gallery-light-blue-pink.png"
      alt="Theme Lab generated light palette with blue links and soft pink lines."
      width={2720}
      height={1708}
      loading="lazy"
      decoding="async"
    ...
    />
    <img
      src="/theme-lab/theme-gallery-light-mint-magenta.png"
      alt="Theme Lab generated light palette with mint lines and magenta accents."
      width={2720}
      height={1708}
      loading="lazy"
      decoding="async"
    ...
    />
    <img
      src="/theme-lab/theme-gallery-light-mint-green.png"
      alt="Theme Lab generated light palette with mint accents and a white surface."
      width={2720}
      height={1708}
      loading="lazy"
      decoding="async"
    ...
    />
    <img
      src="/theme-lab/theme-gallery-dark-green-magenta.png"
      alt="Theme Lab generated dark palette with green surfaces and magenta accents."
      width={2720}
      height={1708}
      loading="lazy"
      decoding="async"
    ...
    />
    <img
      src="/theme-lab/theme-gallery-dark-violet-lime.png"
      alt="Theme Lab generated dark palette with violet surfaces and lime accents."
      width={2720}
      height={1708}
      loading="lazy"
      decoding="async"
    ...
    />
    <img
      src="/theme-lab/theme-gallery-dark-indigo-lime.png"
      alt="Theme Lab generated dark palette with indigo surfaces and lime accents."
      width={2720}
      height={1708}
      loading="lazy"
      decoding="async"
    ...
    />
    <img
      src="/theme-lab/theme-gallery-dark-teal-orange.png"
      alt="Theme Lab generated dark palette with teal surfaces and orange accents."
      width={2720}
      height={1708}
      loading="lazy"
      decoding="async"
  ...
  <style>{`
    ...
    .theme-gallery-slider__image:first-child {
    ...
    @media (prefers-reduced-motion: no-preference) {
      .theme-gallery-slider__image {
        animation: theme-gallery-slide-over 40s infinite both cubic-bezier(0.76, 0, 0.24, 1);
        will-change: transform;
      }

      .theme-gallery-slider__image:nth-child(1) {
        animation-delay: -1s;
      }

      .theme-gallery-slider__image:nth-child(2) {
        animation-delay: 4s;
      }

      .theme-gallery-slider__image:nth-child(3) {
        animation-delay: 9s;
      }

      .theme-gallery-slider__image:nth-child(4) {
        animation-delay: 14s;
      }

      .theme-gallery-slider__image:nth-child(5) {
        animation-delay: 19s;
      }

      .theme-gallery-slider__image:nth-child(6) {
        animation-delay: 24s;
      }

      .theme-gallery-slider__image:nth-child(7) {
        animation-delay: 29s;
      }

      .theme-gallery-slider__image:nth-child(8) {
        animation-delay: 34s;
      }
    }
    ...
    @keyframes theme-gallery-slide-over {
      0% {
        z-index: 3;
        transform: translate3d(calc(100% + 2px), 0, 0);
        visibility: visible;
