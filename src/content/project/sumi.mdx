---
name: Sumi
description: A booking and client operations platform for tattoo artists, bringing intake, CRM, scheduling, deposits, agreements, and shared inbox workflows into one workspace.
screenshots:
...
Sumi is a booking and client operations app for tattoo artists. It brings the entire booking lifecycle into a single workspace: public intake forms, client records, project tracking, scheduling, deposits, signed deposit agreements, and shared inbox workflows.
...
The primary design goal is reducing operational overhead while preserving the flexibility each artist needs in their booking process.
