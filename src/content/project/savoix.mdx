...
I needed to record a demo video for Google to get OAuth scope approval for Linework. The problem: I'm terrible at recording. Every take I'd miss a word, stumble on a line, or ramble off-script. I needed to do multiple takes and find the version where I actually said what I meant to say.
...
Alpha. Served its purpose for the Google demo recording.
