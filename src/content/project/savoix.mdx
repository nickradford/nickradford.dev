...
screenshots:
  - /savoix/savoix-project-workspace.png
githubUrl: https://github.com/nickradford/savoix
---

<ImageGallery title="Savoix" images={[
  {"url":"/savoix/savoix-project-workspace.png","altText":"The main workspace for reviewing segments, recording takes, and validating transcriptions against the original script."},
  {"url":"/savoix/savoix-export-modal.png","altText":"The export flow for reviewing ready segments and choosing the output audio format before generating files."}
]} />
